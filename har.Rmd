...
This analysis will estimate the classification category for manner of barbell lift. The barbell lift activity data is collected using a Human Activity Recognition(har) device. Using a random forrest model we estimate an ~11% out of sample error for predicting the correct classification. 
